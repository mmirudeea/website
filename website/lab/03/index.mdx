...
$$
\text{TOP} = \left( \frac{\mathrm{Clock\ Frequency}}{\mathrm{PWM\ Frequency} \times \mathrm{Divider}} \right) - 1
$$
...
$$
\begin{aligned}
\mathrm{Clock\ Frequency} &= 150 \,\mathrm{MHz} \\
\mathrm{PWM\ Frequency} &= 50 \,\mathrm{Hz} \\
\mathrm{Divider} &= 64
\end{aligned}
$$
...
$$
\mathrm{compare\_value} = \left( \frac{\mathrm{pulse\_width\_us} \times \mathrm{TOP}}{\mathrm{PERIOD\_US}} \right)
$$
