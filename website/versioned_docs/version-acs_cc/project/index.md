...
6. In that directory you must create a file named `index.md` which will be your project page. For a better understanding of the Markdown syntax, chek out [markdownguide](https://www.markdownguide.org/).
