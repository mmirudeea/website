import{d as _,N as u,z as h,f as n,g as t,t as s,B as r,F as f,O as g,o as l,i as v,e as x,C as b}from"../modules/vue-BPvrJPvW.js";import{l as N,k,c as m}from"../index-s9m7gpB9.js";import{_ as y}from"./NoteDisplay.vue_vue_type_style_index_0_lang-CZOpIC0k.js";import"../modules/shiki-C2lQw1o6.js";const w={id:"page-root"},B={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},V={class:"opacity-50"},C={class:"text-lg"},H={class:"font-bold flex gap-2"},S={class:"opacity-50"},z={key:0,class:"border-main mb-8"},A=_({__name:"print",setup(D){const{slides:d,total:p}=N();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
